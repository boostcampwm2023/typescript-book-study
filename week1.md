...
있습니다. [위에서 봤던 예시처럼](https://www.notion.so/Week1-21a7adb987a640a3a48e81c534ad1c38?pvs=21) 타입스크립트가 타입을 any로 추론하게 되면 *
*`implicitAny`** 에러가 발생합니다. 하지만 타입이 any로 추론되어도 에러가 발생하지 않는 경우가 있습니다.
